...
Downloads
---------
 * JavaCPP 1.2.2 binary archive  [javacpp-1.2.2-bin.zip](http://search.maven.org/remotecontent?filepath=org/bytedeco/javacpp/1.2.2/javacpp-1.2.2-bin.zip) (299 KB)
 * JavaCPP 1.2.2 source archive  [javacpp-1.2.2-src.zip](http://search.maven.org/remotecontent?filepath=org/bytedeco/javacpp/1.2.2/javacpp-1.2.2-src.zip) (279 KB)
...
```groovy
  ...
  dependencies {
    compile group: 'org.bytedeco', name: 'javacpp', version: '1.2.2'
  }
```
...
```scala
  ...
  libraryDependencies += "org.bytedeco" % "javacpp" % "1.2.2"
```
