...
//                    decl.declarator = null;
    ...
    public File parse(File outputDirectory, String[] classPath, Class cls, Coordinates coordinates)
        ...
        text += "// The following code has been generated by JavaCPP.\n";
        text += "\n";
        ...
        text += "\n";
        text += "    public static Coordinates coordinates() {\n";
        if (coordinates != null ) {
            text += "        return new Coordinates(";
            text += "\"" + coordinates.group + "\", ";
            text += "\"" + coordinates.id + "\", ";
            text += "\"" + coordinates.version + "\");\n";
        } else
            text += "        return null;\n";
        text += "    }\n";
