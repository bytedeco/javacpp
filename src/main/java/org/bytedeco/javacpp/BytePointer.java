...
public class BytePointer extends Pointer {
    ...
    @ValueGetter
    @Cast("short")
    public native short getShort(long i);
    ...
    @ValueSetter
    @Cast("short")
    public native BytePointer putShort(long i, short s);
    ...
    @ValueGetter
    @Cast("int")
    public native int getInt(long i);
    ...
    @ValueSetter
    @Cast("int")
    public native BytePointer putInt(long i, int j);
    ...
    @ValueGetter
    @Cast("long long")
    public native long getLong(long i);
    ...
    @ValueSetter
    @Cast("long long")
    public native BytePointer putLong(long i, long j);
    ...
    @ValueGetter
    @Cast("float")
    public native float getFloat(long i);
    ...
    @ValueSetter
    @Cast("float")
    public native BytePointer putFloat(long i, float f);
    ...
    @ValueGetter
    @Cast("double")
    public native double getDouble(long i);
    ...
    @ValueSetter
    @Cast("double")
    public native BytePointer putDouble(long i, double d);
    ...
    @ValueGetter
    @Cast("bool")
    public native boolean getBool(long i);
    ...
    @ValueSetter
    @Cast("bool")
    public native BytePointer putBool(long i, boolean b);
    ...
    @ValueGetter
    @Cast("short")
    public native char getChar(long i);
    ...
    @ValueSetter
    @Cast("short")
    public native BytePointer putChar(long i, char c);
    ...
    @ValueSetter
    @Cast("void*")
    public native BytePointer putPointerValue(long i, Pointer p);

    @Cast("char*")
    public static native BytePointer strcat(@Cast("char*") BytePointer dst, @Cast("char*") BytePointer src);

    @Cast("char*")
    public static native BytePointer strchr(@Cast("char*") BytePointer str, int ch);
    ...
    @Cast("char*")
    public static native BytePointer strcpy(@Cast("char*") BytePointer dst, @Cast("char*") BytePointer src);

    @Cast("size_t")
    public static native long strcspn(@Cast("char*") BytePointer str1, @Cast("char*") BytePointer str2);

    @Cast("char*")
    public static native BytePointer strerror(int errnum);

    @Cast("size_t")
    public static native long strlen(@Cast("char*") BytePointer str);

    @Cast("char*")
    public static native BytePointer strncat(@Cast("char*") BytePointer dst, @Cast("char*") BytePointer src, @Cast("size_t") long n);

    public static native int strncmp(@Cast("char*") BytePointer str1, @Cast("char*") BytePointer str2, @Cast("size_t") long n);

    @Cast("char*")
    public static native BytePointer strncpy(@Cast("char*") BytePointer dst, @Cast("char*") BytePointer src, @Cast("size_t") long n);

    @Cast("char*")
    public static native BytePointer strpbrk(@Cast("char*") BytePointer str1, @Cast("char*") BytePointer str2);

    @Cast("char*")
    public static native BytePointer strrchr(@Cast("char*") BytePointer str, int ch);

    @Cast("size_t")
    public static native long strspn(@Cast("char*") BytePointer str1, @Cast("char*") BytePointer str2);

    @Cast("char*")
    public static native BytePointer strstr(@Cast("char*") BytePointer str1, @Cast("char*") BytePointer str2);

    @Cast("char*")
    public static native BytePointer strtok(@Cast("char*") BytePointer str, @Cast("char*") BytePointer delim);

    @Cast("size_t")
    public static native long strxfrm(@Cast("char*") BytePointer dst, @Cast("char*") BytePointer src, @Cast("size_t") long n);
}
