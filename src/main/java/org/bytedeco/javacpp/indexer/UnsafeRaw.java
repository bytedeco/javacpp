...
class UnsafeRaw extends Raw {
    ...
    static {
        ...
        } catch (ClassNotFoundException | IllegalArgumentException | IllegalAccessException | NoSuchFieldException | NoSuchMethodException | SecurityException ex) {
            o = null;
            offset = 0;
        }
        UNSAFE = o;
    ...
    void putBoolean(long address, boolean b) {
        UNSAFE.putByte(address, b ? (byte) 1 : (byte) 0);
    }
