...
public class BufferTest {
    ...
    public void testByteBuffer() {
        ...
        assertEquals(getByte((ByteBuffer) arrayBuffer.position(arrayBuffer.position() + 2)), getByte((ByteBuffer) directBuffer.position(directBuffer.position() + 2)));
    }
    ...
    public void testShortBuffer() {
        ...
        assertEquals(getShort((ShortBuffer) arrayBuffer.position(arrayBuffer.position() + 2)), getShort((ShortBuffer) directBuffer.position(directBuffer.position() + 2)));
    }
    ...
    public void testIntBuffer() {
        ...
        assertEquals(getInt((IntBuffer) arrayBuffer.position(arrayBuffer.position() + 2)), getInt((IntBuffer) directBuffer.position(directBuffer.position() + 2)));
    }
    ...
    public void testLongBuffer() {
        ...
        assertEquals(getLong((LongBuffer) arrayBuffer.position(arrayBuffer.position() + 2)), getLong((LongBuffer) directBuffer.position(directBuffer.position() + 2)));
    }
    ...
    public void testFloatBuffer() {
        ...
        assertEquals(getFloat((FloatBuffer) arrayBuffer.position(arrayBuffer.position() + 2)), getFloat((FloatBuffer) directBuffer.position(directBuffer.position() + 2)), 0.0);
    }
    ...
    public void testDoubleBuffer() {
        ...
        assertEquals(getDouble((DoubleBuffer) arrayBuffer.position(arrayBuffer.position() + 2)), getDouble((DoubleBuffer) directBuffer.position(directBuffer.position() + 2)), 0.0);
    }
}
